    ...
    items: [
      {
        name: "controlISP",
        status: "Activo",
        type: "Sistema de gestión web",
        description:
          "Sistema de gestión y control para proveedores de servicios de internet (ISPs): administración de clientes, suscriptores, facturación y reportes.",
        features: [
          "Gestión de clientes",
      ...
      },
      {
        ...
        description:
          "Sistema de punto de venta (POS) para negocios y bodegas: ventas rápidas, inventario y control de stock en tiempo real.",
        features: [
          "Ventas rápidas",
          "Inventario",
          "Control de stock",
